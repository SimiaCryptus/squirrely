...
export class Perception {
  ...
  sense(v, eff, dt) {
    ...
    if (L && lg <= eff.sensorRange) {
      P.leader = P._leader;
      P.leader.veh = L;
      P.leader.s = lg;
    } else P.leader = null;
    if (F && fg <= eff.sensorRange) {
      P.follower = P._follower;
      P.follower.veh = F;
      P.follower.s = fg;
    } else P.follower = null;
