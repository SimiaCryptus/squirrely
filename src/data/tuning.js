...
export const TUNING = {
  ...
  staminaTaunt: 0.05,
  staminaRegen: 0.2,
  staminaCrouchBoost: 2.0,
  staminaAcorn: 0.5,
  staminaCooldownMax: 0.6,
  ...
  smokeDistract: 30,
  smokeStopRange: 35,
  smokeStopWidth: 2.5, // a plume halts traffic approaching it within radius + width either side
