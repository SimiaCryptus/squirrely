...
// Multispeed traffic (§7.6): lanes run at different limits and each colour treats that differently —
//   impatience      how fast its temper rises behind a slower leader (tailgating, lower change threshold, less politeness)
//   laneSpeedAdopt  how much of a new lane's limit it adopts as its own desired speed (1 = law-abiding, 0 = keeps its pace)
//   speedSeek       how hard it drifts toward the lane whose limit matches its own desired speed
export const DRIVERS = {
  red: {
    ...
    impatience: 0.5, laneSpeedAdopt: 0.3, speedSeek: 0.3,     // boils in seconds, limits are for other people, wants the fast lane
  ...
  yellow: {
    ...
    impatience: 0.15, laneSpeedAdopt: 0.7, speedSeek: 0.4,
  ...
  blue: {
    ...
    impatience: 0.05, laneSpeedAdopt: 0.9, speedSeek: 0.5,
  ...
  green: {
    ...
    impatience: 0.3, laneSpeedAdopt: 0.6, speedSeek: 0.6,
  ...
  purple: {
    ...
    impatience: 0.0, laneSpeedAdopt: 0.2, speedSeek: 0.15,    // never noticed the limit changed; drifts wherever
    extras: { flinch: 1.1 },
  },
  white: {
    ...
    impatience: 0.0, laneSpeedAdopt: 1.0, speedSeek: 0.8,     // drives the limit of whatever lane it is in
    extras: {},
  },
};

export const DRIVER_RULES = {
  red: "Red hunts. Don't be in front of it — break line of sight or crouch. It wants the fast lane and boils behind anyone slower.",
  ...
  green: 'Green rages in slow traffic. Watch it when a lane jams or a slower car sits in front of it.',
  purple: "Purple didn't see you. It never does until it's too late — and it never noticed the speed limit changed either.",
  white: 'White is steady. It only brakes — never swerves — and drives the limit of the lane it is in. Build your plan on it.',
};